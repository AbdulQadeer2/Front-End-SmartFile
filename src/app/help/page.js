                                ...
                                <div className="row">
                                    <div className="col-lg-12">
                                        <div className="breadcrumb-inner text-center">
                                            <h3 className="title h3">Help Support</h3>
                                            ...
                                            <div className="rainbow-accordion-style accordion rainbow-section-gapBottom">
                                                <div className="accordion" id="accordionExamplea">
                                                    <div className="accordion-item card ">
                                                        ...
                                                        >
                                                            <div className="accordion-body card-body">
                                                                AiWaveis an AI-powered messaging platform that
                                                                understands and responds to your natural language
                                                                queries. Ask anything you&apos;d typically ask a human
                                                                assistant—get weather updates, news, restaurant
                                                    ...
                                                    <div className="accordion-item card ">
                                                        ...
                                                        >
                                                            <div className="accordion-body card-body">
                                                                AiWave, an AI-driven messaging platform, adeptly
                                                    ...
                                                    <div className="accordion-item card ">
                                                        ...
                                                        >
                                                            <div className="accordion-body card-body">
                                                                Yes, We will get update the AiWave. And you can get
                                                    ...
                                                    <div className="accordion-item card ">
                                                        ...
                                                        >
                                                            <div className="accordion-body card-body">
                                                                Feel free to toss any questions at AiWave, just like
                                                                you would with a human helper—whether it&apos;s about the
                                                                weather, the latest news, restaurant suggestions, or
                                                    ...
                                                    <div className="accordion-item card ">
                                                        ...
                                                        >
                                                            <div className="accordion-body card-body">
                                                                Yes, AiWaveis designed to support multiple
                                                                languages, offering a versatile and inclusive
                                                                communication experience for users worldwide.
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
